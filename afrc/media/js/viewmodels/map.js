...
const viewModel = function (params) {
    ...
    var boundingOptions = {
        ...
        animate: false,
        maxZoom: 10, // added for issue #148 from arches 8.0.0
    };
    // added to allow for user to override default boundingOptions #148 from arches 8.0.0
    Object.assign(boundingOptions, params.fitBoundsOptions || {});
