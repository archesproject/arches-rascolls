...
SECRET_KEY = "django-insecure-_u6%r8rchhf3pdc=*4c&6+hi_!low2jdthg+a0jq2z6y5yricw"
...
CELERY_BROKER_URL = "amqp://guest:guest@localhost"  #Redis --> "redis://localhost:6379/0"
