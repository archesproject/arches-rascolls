...
import PopupContainer from "@/arches_rascolls/Search/components/InteractiveMap/components/PopupContainer/PopupContainer.vue";
...
} from "@/arches_rascolls/Search/api.ts";
