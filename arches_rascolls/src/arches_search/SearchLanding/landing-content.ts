        ...
        tabs: [
            {
                ...
                icon: "pi pi-star",
                component: "arches_rascolls/SearchLanding/components/FeaturedItemsTab",
            },
            {
                slug: "resource-types",
                label: $gettext("Resource Types"),
                icon: "pi pi-sitemap",
                component: "arches_search/SearchLanding/components/ResourceTypesTab",
            },
            {
                slug: "map",
                label: $gettext("Map"),
                icon: "pi pi-map",
                component: "arches_search/SearchLanding/components/MapTab/MapTab",
            },
            {
                slug: "saved-searches",
                label: $gettext("Saved Searches"),
                icon: "pi pi-bookmark-fill",
                component: "arches_search/SearchLanding/components/SavedSearchesTab",
            },
        ],
    };
}
